        ...
        let gotoBlock = (targetBlock, noHeader = false, speed = 500, offsetTop = 0) => {
            ...
            if (targetBlockElement) {
                ...
                function scrollToPosition(currentTime) {
                    ...
                    if (elapsedTime < duration) requestAnimationFrame(scrollToPosition);
                }
...
***************************************************************************** */
        ...
        window.addEventListener("load", (function(e) {
            const bgItems = document.querySelectorAll("[data-bg]");
            if (bgItems.length) bgItems.forEach((bgItem => {
            ...
            if (document.querySelector(".video-module")) {
                ...
                videoModule.addEventListener("click", (function(e) {
                    if (!videoModule.classList.contains("_init")) {
                        ...
                        if (window.innerWidth < 767.98) videoElement.controls = true; else videoElement.controls = false;
                    } else {
